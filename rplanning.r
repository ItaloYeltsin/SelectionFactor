...
factor = "./results/ReleasePlanning_FACTOR_FUN.txt";
fitness = "./results/ReleasePlanning_FUN.txt";
max_risk ="./results/ReleasePlanning_MAX_RISK_FUN.txt";
max_score = "./results/ReleasePlanning_MAX_SCORE_FUN.txt";
min_risk = "./results/ReleasePlanning_MIN_RISK_FUN.txt";
min_score = "./results/ReleasePlanning_MIN_SCORE_FUN.txt";
...
write.table(output, file="results/RP_dataset1.result", sep = "\t", na = "-")
