...
public class GA_test {
  ...
  public void main(String problemName,String complement,int cont,int cont2) throws JMException, ClassNotFoundException, IOException {
    ...
    SolutionSet population = configAlgorithm(problem);
    ...
    population.printObjectivesToFile("results/"+problemName+complement+"_FUN.txt",absoluteValue,cont2);
...
//      }
  ...
  SolutionSet configAlgorithm(Problem problem) throws JMException, ClassNotFoundException {
